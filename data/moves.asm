...
MoveEnd:
	...
	move BITE,         FLINCH_SIDE_EFFECT1,         40, DARK,     100, 25
	...
	move CRUNCH,       DEFENSE_DOWN_SIDE_EFFECT,    85, DARK,     100, 15
	move BRUTAL_SWING, NO_ADDITIONAL_EFFECT,        60, DARK,     100, 20
	move DARK_PULSE,   FLINCH_SIDE_EFFECT2,         70, DARK,     100, 20
	move PURSUIT,      NO_ADDITIONAL_EFFECT,        60, DARK,     100, 20
	...
	move DRAININGKISS, DRAIN_HP_EFFECT,             40, FAIRY,    100, 10
	move FAIRY_WIND,   NO_ADDITIONAL_EFFECT,        40, FAIRY,    100, 30
	move MOONBLAST,    SPECIAL_DOWN_SIDE_EFFECT,    90, FAIRY,    100, 10
	move PLAY_ROUGH,   ATTACK_DOWN_SIDE_EFFECT,     70, FAIRY,    100, 20
	move BUG_BITE,     NO_ADDITIONAL_EFFECT,        60, BUG,      100, 15
	move INFESTATION,  TRAPPING_EFFECT,             15, BUG,       85, 20
	move MEGA_HORN,    NO_ADDITIONAL_EFFECT,       120, BUG,       85, 5
	...
	move ROCK_BLAST,   TWO_TO_FIVE_ATTACKS_EFFECT,  25, ROCK,     100, 30
	...
	move ASTONISH,     FLINCH_SIDE_EFFECT2,         60, GHOST,     95, 15
